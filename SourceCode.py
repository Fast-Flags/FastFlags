...
class FastFlagsBot:
    ...
    def __repr__(self):
        return f"<FastFlagsBot vibe={self.vibe!r} 100% python certified>"
...
if __name__ == "__main__":
    ...
    for i in range(3):
        print("Gooby this gooby that gooby server gooby lan gooby stkeak gooby ham asian gooby fram japan now i am goobing with my friends" * (i + 1)
